...
const ADD_CALLBACK = 'ADD_CALLBACK';
...
const initialState = {
  ...
  visiterInfo: {
    ...
    myCenters: [],
    myAdresses: [],
    callBack: { isAdded: false, phone: '', name: '' },
  },
  searchFilter: [],
  cities: [
    'Москва ',
...
export const addCallBackAC = (data) => ({ type: ADD_CALLBACK, data });
...
export const refreshFilterAC = () => ({ type: REFRESH_FILTER });
